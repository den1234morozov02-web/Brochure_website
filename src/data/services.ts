...
export const rituals: Ritual[] = [
  ...
  {
    id: "harmony-within",
    image: "/media/ritual-harmony-within.jpg",
    duration: 120,
    price: 135,
    name: { en: "Harmony Within Ritual", uk: "Ритуал «Гармонія всередині»" },
    subtitle: {
      en: "2-Hour Holistic Journey",
      uk: "2-годинна холістична подорож",
    },
    desc: {
      en: "A deeply nurturing journey designed to restore balance, release tension and reconnect you with yourself.",
      uk: "Глибоко дбайлива подорож, створена щоб відновити баланс, зняти напругу та повернути зв'язок із собою.",
    },
    includes: {
      en: [
        "Consultation & aroma selection",
        "Pranayama (breathwork)",
        "Reflexology",
        "Peppermint foot mask & hot boots",
        "Indian head ritual",
        "Shavasana (deep relaxation)",
        "Organic herbal tea",
      ],
      uk: [
        "Консультація та підбір аромаолій",
        "Пранаяма (дихальні практики)",
        "Рефлексологія",
        "М'ятна маска та теплі чобітки для ніг",
        "Індійський ритуал для голови",
        "Шавасана (глибоке розслаблення)",
        "Органічний трав'яний чай",
      ],
    },
  },
  {
    id: "radiance-facial",
    image: "/media/ritual-radiance-facial.jpg",
    duration: 75,
    price: 80,
    name: { en: "Radiance Facial Ritual", uk: "Сяйний ритуал для обличчя" },
    subtitle: { en: "Facial Ritual", uk: "Ритуал для обличчя" },
    desc: {
      en: "Perfect for those seeking radiant skin, deep relaxation and a moment of restorative self-care.",
      uk: "Ідеально для тих, хто прагне сяючої шкіри, глибокого розслаблення та миті відновлювального догляду за собою.",
    },
    includes: {
      en: [
        "Personal consultation & skin assessment",
        "Deep cleansing & exfoliation",
        "Face, neck & décolletage massage",
        "Personalised treatment mask",
        "Indian head or hand & arm massage",
        "Peppermint foot mask & warm booties",
        "Serum & moisture finish",
        "Herbal tea & moment of stillness",
      ],
      uk: [
        "Консультація та оцінка стану шкіри",
        "Глибоке очищення та ексфоліація",
        "Масаж обличчя, шиї та декольте",
        "Індивідуальна доглядова маска",
        "Індійський масаж голови або масаж рук",
        "М'ятна маска та теплі чобітки для ніг",
        "Сироватка та зволожуюче завершення",
        "Трав'яний чай і мить спокою",
      ],
    },
  },
  {
    id: "deep-cleansing",
    image: "/media/ritual-deep-cleansing.jpg",
    duration: 75,
    price: 85,
    name: { en: "Deep Cleansing Ritual", uk: "Ритуал глибокого очищення" },
    subtitle: { en: "Facial Ritual", uk: "Ритуал для обличчя" },
    desc: {
      en: "Perfect for clear, refreshed and radiant skin, and a moment of deep relaxation.",
      uk: "Ідеально для чистої, свіжої та сяючої шкіри й миті глибокого розслаблення.",
    },
    includes: {
      en: [
        ...
        "Pore closing mask",
        "Indian head or hand & shoulder massage",
        "Peppermint foot mask & warm booties",
        "Serum & moisturising finish",
        "Herbal tea & moment of stillness",
      ],
      uk: [
        "Особиста консультація",
        "Глибоке очищення та ексфоліація",
        "Маска для розкриття пор",
        "Ультразвукове очищення",
        "Маска для звуження пор",
        "Індійський масаж голови або масаж плечей",
        "М'ятна маска та теплі чобітки для ніг",
        "Сироватка та зволожуюче завершення",
        "Трав'яний чай і мить спокою",
      ],
